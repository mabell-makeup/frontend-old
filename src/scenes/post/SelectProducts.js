...
import {ITEM_SEARCH_PLACE_HOLDER} from "../../styles/constants"
...
export const SelectProducts = ({navigation}) => {
  ...
  useEffect(() => {
    navigation.setOptions({
      ...
      // eslint-disable-next-line react/display-name
      headerTitle: () => <IconTextInput placeholder={ITEM_SEARCH_PLACE_HOLDER} onChangeText={text => fetchProducts(dispatch, text)} />
    })
